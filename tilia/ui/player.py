        ...
        match state:
            case PlayerStatus.NO_MEDIA:
                for widget in self.children():
                    if widget.inherits("QToolButton") or widget.inherits("QAction") or widget.inherits("QSlider") or widget.inherits("QDoubleSpinBox"):
                        widget.setToolTip("<i>Player disabled. Load file via '</i>File > Load Media File<i>' to start.</i>")
            ...
            case PlayerStatus.WAITING_FOR_YOUTUBE:
                for widget in self.children():
                    if widget.inherits("QToolButton") or widget.inherits("QAction") or widget.inherits("QSlider") or widget.inherits("QDoubleSpinBox"):
                        widget.setToolTip("<i>Player disabled. Click on YouTube video to enable player.</i>")
                self.setEnabled(False)
